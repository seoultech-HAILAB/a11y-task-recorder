...
8. **타임라인 재생 · “여기였나요?”**에서 발화와 입력을 되짚고 불편 시작/끝을
   확인한 뒤 문제 설명을 등록합니다.
...
7. 종료 후 회고 패널의 이전/다음으로 입력과 NVDA 발화를 되짚습니다. 참여자에게
   “불편했던 곳이 여기였나요?”라고 확인하고 **여기였어요**, **불편 시작**,
   **불편 끝**으로 범위를 지정합니다.
...
- 종료 후 회고에서 “여기였어요”를 누르면 이벤트와 step 구간이 문제 양식에 연결되는가
